...
function buildSystemPrompt() {
    return `אתה מנתח דוחות סוקר סיכונים באתרי בניה.
המשימה: חילוץ נתונים מובנים לפי הסכימה המצורפת (JSON Schema).
אם שדה לא מופיע במסמך – החזר ערך null או מחרוזת ריקה "" (לפי הטיפוס).
היענות בעברית היכן שמתאים בתיאורים חופשיים.
חשוב: החזר תמיד JSON תקין לפי הסכימה.`;
}
