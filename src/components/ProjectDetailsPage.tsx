...
export default function ProjectDetailsPage({ currentUser }: ProjectDetailsPageProps) {
    ...
    const [bankBranches, setBankBranches] = useState<{ [bankName: string]: string[] }>({
        'בנק הפועלים בע״מ': ['001', '002', '003', '678', '123'],
        'בנק לאומי לישראל בע״מ': ['001', '002', '003', '678', '123'],
        'בנק דיסקונט בע״מ': ['001', '002', '003', '500', '600'],
        'Citibank בע״מ': ['1', '2'],
        'HSBC בע״מ': ['102']
    });
    const [branchDetails, setBranchDetails] = useState<{ [key: string]: { address: string, amount: string } }>({
        'בנק הפועלים בע״מ_001': { address: 'רחוב הרצל 1, תל אביב', amount: '' },
        'בנק הפועלים בע״מ_002': { address: 'רחוב דיזנגוף 100, תל אביב', amount: '' },
        'בנק הפועלים בע״מ_003': { address: 'רחוב אלנבי 50, תל אביב', amount: '' },
        'בנק לאומי לישראל בע״מ_001': { address: 'רחוב רוטשילד 1, תל אביב', amount: '' },
        'בנק לאומי לישראל בע״מ_678': { address: 'דרך מנחם בגין 121, תל אביב -יפו', amount: '' },
        'בנק לאומי לישראל בע״מ_123': { address: 'רחוב הרצל 15, ירושלים', amount: '' },
        'בנק דיסקונט בע״מ_001': { address: 'שדרות רוטשילד 20, תל אביב -יפו', amount: '' },
        'Citibank בע״מ_1': { address: 'דרך מנחם בגין 121 מגדל עזריאלי שרונה, תל אביב -יפו', amount: '' },
        'HSBC בע״מ_102': { address: 'ז\'בוטינסקי 2 בית אמות אטריום, רמת גן', amount: '' },
        'בנק לאומי לישראל בע״מ_002': { address: 'רחוב בן יהודה 100, תל אביב', amount: '' },
        'בנק לאומי לישראל בע״מ_003': { address: 'רחוב הרצל 50, תל אביב', amount: '' },
        'בנק דיסקונט בע״מ_002': { address: 'רחוב דיזנגוף 100, תל אביב', amount: '' },
        'בנק דיסקונט בע״מ_003': { address: 'רחוב אלנבי 50, תל אביב', amount: '' }
    });
    ...
    const handleSave = async () => {
        try {
            console.log('🚀 SAVE BUTTON CLICKED - Starting save process - VERSION 3 - FORCE DEPLOY');
            ...
            <Box sx={{ p: 2 }}>
                <Paper elevation={1} sx={{ height: 'calc(100vh - 120px)', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Box sx={{ p: { xs: 1, sm: 2, md: 3 }, pb: { xs: 3, sm: 4, md: 6 }, flex: 1, display: 'flex', flexDirection: 'column', overflow: 'auto', width: '100%', maxWidth: '100%' }}>
                                                ...
                                                <IconButton
                                                    onClick={async () => {
                                                        ...
                                                        try {
                                                            ...
                                                            const [fireStation, policeStation, fuelStation, firstAidStation] = await Promise.all([
                                                                gisService.getNearestFireStation(x, y),
                                                                gisService.getNearestPoliceStation(x, y),
                                                                gisService.getNearestFuelStation(x, y),
                                                                gisService.getNearestFirstAidStation(x, y)
                                                            ]);
                                ...
                                <Box sx={{ mb: 4 }}>
                                    ...
                                    <TableContainer component={Paper} sx={{ boxShadow: 'none', border: '1px solid #e0e0e0' }}>
                                        <Table>
                                            <TableHead>
                                                <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                                                    <TableCell sx={{ fontWeight: 'bold', textAlign: 'right', width: '25%' }}>סוג המסמך</TableCell>
                                                    <TableCell sx={{ fontWeight: 'bold', textAlign: 'right', width: '30%' }}>תיאור המסמך</TableCell>
                                                    <TableCell sx={{ fontWeight: 'bold', textAlign: 'right', width: '35%' }}>קובץ</TableCell>
                                            ...
                                            <TableBody>
                                                ...
                                                {canEdit && (
                                                    <TableRow>
                                                        <TableCell colSpan={4} sx={{ textAlign: 'center', borderBottom: 'none', py: 2 }}>
                                                            <Button
                                                                variant="outlined"
                                                                startIcon={<AddIcon />}
                                                                onClick={() => {
                                                ...
                                                <Box sx={{
                                                    ...
                                                    <Button
                                                        ...
                                                        sx={{
                                                            ...
                                                            border: '1px solid #d1d5db',
                                                            borderLeft: 'none',
                                                            backgroundColor: project?.machineryCoverage === false ? '#6b47c1' : 'transparent',
                                                            color: project?.machineryCoverage === false ? 'white' : '#6b47c1',
                                                            '&:hover': {
                                                                backgroundColor: project?.machineryCoverage === false ? '#5a3aa1' : '#f3f4f6',
                                                            },
                                                            minWidth: '50px',
                                                            height: '32px',
                                                            textTransform: 'none',
                                            ...
                                            <Box sx={{
                                                ...
                                                <Box sx={{
                                                    ...
                                                    <Button
                                                        variant="text"
                                                        onClick={() => {
                                                            console.log('🔍 Before handleNestedFieldChange, theftCoverage:', project?.insuranceSpecification?.theftCoverage);
                                                            console.log('🔍 Type of theftCoverage:', typeof project?.insuranceSpecification?.theftCoverage);
                                                            console.log('🔍 Full project insuranceSpecification:', project?.insuranceSpecification);
                                                            handleNestedFieldChange('insuranceSpecification.theftCoverage.isActive', true);
                                                        }}
                                                        disabled={mode === 'view' || !canEdit}
                                                        sx={{
                                                            borderRadius: '4px 0 0 4px',
                                                ...
                                                <Box sx={{
                                                    ...
                                                    <Button
                                                        ...
                                                        sx={{
                                                            ...
                                                            border: '1px solid #d1d5db',
                                                            borderLeft: 'none',
                                                            backgroundColor: project?.workPropertyCoverage === false ? '#6b47c1' : 'transparent',
                                                            color: project?.workPropertyCoverage === false ? 'white' : '#6b47c1',
                                                            '&:hover': {
                                                                backgroundColor: project?.workPropertyCoverage === false ? '#5a3aa1' : '#f3f4f6',
                                                            },
                                                            minWidth: '50px',
                                                            height: '32px',
                                                            textTransform: 'none',
                                                ...
                                                <Box sx={{
                                                    ...
                                                    <Button
                                                        ...
                                                        sx={{
                                                            ...
                                                            border: '1px solid #d1d5db',
                                                            borderLeft: 'none',
                                                            backgroundColor: project?.adjacentPropertyCoverage === false ? '#6b47c1' : 'transparent',
                                                            color: project?.adjacentPropertyCoverage === false ? 'white' : '#6b47c1',
                                                            '&:hover': {
                                                                backgroundColor: project?.adjacentPropertyCoverage === false ? '#5a3aa1' : '#f3f4f6',
                                                            },
                                                            minWidth: '50px',
                                                            height: '32px',
                                                            textTransform: 'none',
                                                ...
                                                <Box sx={{
                                                    ...
                                                    <Button
                                                        ...
                                                        sx={{
                                                            ...
                                                            border: '1px solid #d1d5db',
                                                            borderLeft: 'none',
                                                            backgroundColor: project?.transitPropertyCoverage === false ? '#6b47c1' : 'transparent',
                                                            color: project?.transitPropertyCoverage === false ? 'white' : '#6b47c1',
                                                            '&:hover': {
                                                                backgroundColor: project?.transitPropertyCoverage === false ? '#5a3aa1' : '#f3f4f6',
                                                            },
                                                            minWidth: '50px',
                                                            height: '32px',
                                                            textTransform: 'none',
                                                ...
                                                <Box sx={{
                                                    ...
                                                    <Button
                                                        ...
                                                        sx={{
                                                            ...
                                                            border: '1px solid #d1d5db',
                                                            borderLeft: 'none',
                                                            backgroundColor: project?.auxiliaryBuildingsCoverage === false ? '#6b47c1' : 'transparent',
                                                            color: project?.auxiliaryBuildingsCoverage === false ? 'white' : '#6b47c1',
                                                            '&:hover': {
                                                                backgroundColor: project?.auxiliaryBuildingsCoverage === false ? '#5a3aa1' : '#f3f4f6',
                                                            },
                                                            minWidth: '50px',
                                                            height: '32px',
                                                            textTransform: 'none',
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-end' }}>
                                            <Box sx={{ border: '1px solid #d1d5db', borderRadius: '4px', backgroundColor: 'white', minHeight: '56px', padding: '0 14px', direction: 'rtl', display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                                                ...
                                                <Box sx={{ display: 'flex', gap: 0, alignItems: 'center', justifyContent: 'flex-start', marginLeft: '10px' }}>
                                                    <Button variant="text" onClick={() => handleNestedFieldChange('insuranceSpecification.debrisRemoval.isActive', false)} disabled={mode === 'view' || !canEdit} sx={{ borderRadius: '0 4px 4px 0', border: '1px solid #d1d5db', borderLeft: 'none', backgroundColor: project?.insuranceSpecification?.debrisRemoval?.isActive === false ? '#6b47c1' : 'transparent', color: project?.insuranceSpecification?.debrisRemoval?.isActive === false ? 'white' : '#6b47c1', '&:hover': { backgroundColor: project?.insuranceSpecification?.debrisRemoval?.isActive === false ? '#5a3aa1' : '#f3f4f6' }, minWidth: '50px', height: '32px', textTransform: 'none', fontSize: '0.875rem', marginRight: '0px' }}>לא</Button>
                                                    <Button variant="text" onClick={() => handleNestedFieldChange('insuranceSpecification.debrisRemoval.isActive', true)} disabled={mode === 'view' || !canEdit} sx={{ borderRadius: '4px 0 0 4px', border: '1px solid #d1d5db', backgroundColor: project?.insuranceSpecification?.debrisRemoval?.isActive === true ? '#6b47c1' : 'transparent', color: project?.insuranceSpecification?.debrisRemoval?.isActive === true ? 'white' : '#6b47c1', '&:hover': { backgroundColor: project?.insuranceSpecification?.debrisRemoval?.isActive === true ? '#5a3aa1' : '#f3f4f6' }, minWidth: '50px', height: '32px', textTransform: 'none', fontSize: '0.875rem' }}>כן</Button>
                                                </Box>
                                            </Box>
                                        </Box>
                                        <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                                            {project?.insuranceSpecification?.debrisRemoval?.isActive === true && (
                                    ...
                                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2, mb: 2 }}>
                                        <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-end' }}>
                                            <Box sx={{ border: '1px solid #d1d5db', borderRadius: '4px', backgroundColor: 'white', minHeight: '56px', padding: '0 14px', direction: 'rtl', display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                                                ...
                                                <Box sx={{ display: 'flex', gap: 0, alignItems: 'center', justifyContent: 'flex-start', marginLeft: '10px' }}>
                                                    <Button variant="text" onClick={() => handleNestedFieldChange('insuranceSpecification.architectFees.isActive', false)} disabled={mode === 'view' || !canEdit} sx={{ borderRadius: '0 4px 4px 0', border: '1px solid #d1d5db', borderLeft: 'none', backgroundColor: project?.insuranceSpecification?.architectFees?.isActive === false ? '#6b47c1' : 'transparent', color: project?.insuranceSpecification?.architectFees?.isActive === false ? 'white' : '#6b47c1', '&:hover': { backgroundColor: project?.insuranceSpecification?.architectFees?.isActive === false ? '#5a3aa1' : '#f3f4f6' }, minWidth: '50px', height: '32px', textTransform: 'none', fontSize: '0.875rem', marginRight: '0px' }}>לא</Button>
                                                    <Button variant="text" onClick={() => handleNestedFieldChange('insuranceSpecification.architectFees.isActive', true)} disabled={mode === 'view' || !canEdit} sx={{ borderRadius: '4px 0 0 4px', border: '1px solid #d1d5db', backgroundColor: project?.insuranceSpecification?.architectFees?.isActive === true ? '#6b47c1' : 'transparent', color: project?.insuranceSpecification?.architectFees?.isActive === true ? 'white' : '#6b47c1', '&:hover': { backgroundColor: project?.insuranceSpecification?.architectFees?.isActive === true ? '#5a3aa1' : '#f3f4f6' }, minWidth: '50px', height: '32px', textTransform: 'none', fontSize: '0.875rem' }}>כן</Button>
                                                </Box>
                                            </Box>
                                        </Box>
                                        <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                                            {project?.insuranceSpecification?.architectFees?.isActive === true && (
                                                <TextField fullWidth label="סכום הביטוח (₪)" value={project?.insuranceSpecification?.architectFees?.insuranceSum ? parseInt(project.insuranceSpecification.architectFees.insuranceSum.toString()).toLocaleString('he-IL') : ''} onChange={(e) => { const numericValue = e.target.value.replace(/[^\d]/g, ''); handleNestedFieldChange('insuranceSpecification.architectFees.insuranceSum', numericValue ? parseInt(numericValue) : 0); }} disabled={mode === 'view' || !canEdit} size="small" type="text" inputMode="numeric" sx={{ direction: 'rtl', '& .MuiInputBase-root': { minHeight: '56px' }, '& .MuiInputLabel-root': { top: '0px' } }} />
                                            )}
                                            {project?.insuranceSpecification?.architectFees?.isActive === true && (
                                    ...
                                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2, mb: 2 }}>
                                        <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-end' }}>
                                            <Box sx={{ border: '1px solid #d1d5db', borderRadius: '4px', backgroundColor: 'white', minHeight: '56px', padding: '0 14px', direction: 'rtl', display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                                                ...
                                                <Box sx={{ display: 'flex', gap: 0, alignItems: 'center', justifyContent: 'flex-start', marginLeft: '10px' }}>
                                                    <Button variant="text" onClick={() => handleNestedFieldChange('insuranceSpecification.authorityChanges.isActive', false)} disabled={mode === 'view' || !canEdit} sx={{ borderRadius: '0 4px 4px 0', border: '1px solid #d1d5db', borderLeft: 'none', backgroundColor: project?.insuranceSpecification?.authorityChanges?.isActive === false ? '#6b47c1' : 'transparent', color: project?.insuranceSpecification?.authorityChanges?.isActive === false ? 'white' : '#6b47c1', '&:hover': { backgroundColor: project?.insuranceSpecification?.authorityChanges?.isActive === false ? '#5a3aa1' : '#f3f4f6' }, minWidth: '50px', height: '32px', textTransform: 'none', fontSize: '0.875rem', marginRight: '0px' }}>לא</Button>
                                                    <Button variant="text" onClick={() => handleNestedFieldChange('insuranceSpecification.authorityChanges.isActive', true)} disabled={mode === 'view' || !canEdit} sx={{ borderRadius: '4px 0 0 4px', border: '1px solid #d1d5db', backgroundColor: project?.insuranceSpecification?.authorityChanges?.isActive === true ? '#6b47c1' : 'transparent', color: project?.insuranceSpecification?.authorityChanges?.isActive === true ? 'white' : '#6b47c1', '&:hover': { backgroundColor: project?.insuranceSpecification?.authorityChanges?.isActive === true ? '#5a3aa1' : '#f3f4f6' }, minWidth: '50px', height: '32px', textTransform: 'none', fontSize: '0.875rem' }}>כן</Button>
                                                </Box>
                                            </Box>
                                        </Box>
                                        <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                                            {project?.insuranceSpecification?.authorityChanges?.isActive === true && (
                                                <TextField fullWidth label="סכום הביטוח (₪)" value={project?.insuranceSpecification?.authorityChanges?.insuranceSum ? parseInt(project.insuranceSpecification.authorityChanges.insuranceSum.toString()).toLocaleString('he-IL') : ''} onChange={(e) => { const numericValue = e.target.value.replace(/[^\d]/g, ''); handleNestedFieldChange('insuranceSpecification.authorityChanges.insuranceSum', numericValue ? parseInt(numericValue) : 0); }} disabled={mode === 'view' || !canEdit} size="small" type="text" inputMode="numeric" sx={{ direction: 'rtl', '& .MuiInputBase-root': { minHeight: '56px' }, '& .MuiInputLabel-root': { top: '0px' } }} />
                                            )}
                                            {project?.insuranceSpecification?.authorityChanges?.isActive === true && (
                        ...
                        {activeTab === 4 && (project?.status === 'current' || project?.status === 'completed') && (
                            <Box>
