...
function App() {
  ...
  const checkAuthStatus = async () => {
    ...
    if (sessionId) {
      ...
      // Create user based on saved email
      const savedEmail = localStorage.getItem('userEmail');
      if (savedEmail) {
        console.log('✅ Creating user from saved email:', savedEmail);
        let userRole = 'user';
        let userName = 'Liav Geffen';
        
        if (savedEmail === 'liav@chocoinsurance.com') {
          userRole = 'admin';
    ...
    if (storedSessionId) {
      const savedEmail = localStorage.getItem('userEmail');
      if (savedEmail) {
        console.log('✅ User already authenticated with email:', savedEmail);
        let userRole = 'user';
        let userName = 'Liav Geffen';
