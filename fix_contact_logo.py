...
# Read the file
with open('server/routes/contact-auth.js', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Write back to file
with open('server/routes/contact-auth.js', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("✅ Logo URL updated in contact-auth.js")
